...
NODE_VERSION=$(curl -L https://nodejs.org/en/ | grep "LTS" | grep -Eo "[0-9]{1,3}(\.[0-9]{1,3}){1,2}" | sed -n "1p")
NVIM_VERSION="stable"
...
function install_apps() {
	...
	judge "install proxychains4 yt-dlp openvpn openconnect wireguard (VPN Tools and YT Downloader)"
